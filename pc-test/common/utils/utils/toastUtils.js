...
import ConfirmButton from '../components/common/gx-confirm-button'
import {getPopupTitle} from "@/utils/popupUtil";
...
export const toast = {
    ...
    success(content = '保存成功') {
        listen.$message({type: 'success', message: content, duration: 2000});
    },
